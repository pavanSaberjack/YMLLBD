...
//            CGFloat spacing = [self valueForOption:iCarouselOptionSpacing withDefault:0.25f];
            ...
            CGFloat tilt = [self valueForOption:iCarouselOptionTilt withDefault:0.04f];
            CGFloat spacing = [self valueForOption:iCarouselOptionSpacing withDefault:1.1f]; // should be ~ 1/scrollSpeed;
...
- (UIView *)containView:(UIView *)view
{
    ...
    if (!_itemWidth)
    {
        _itemWidth = _vertical? view.bounds.size.height: view.bounds.size.width + 30;
    }
